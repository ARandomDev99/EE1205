...
\begin{tikzpicture}[font=\footnotesize]
    \draw[-Stealth] (0,0) node[left]{$R(s)$} -- (1.5,0) node[below left]{$+$};
    \filldraw[color=black, fill=white, very thick] (2,0) circle (.5);
    \draw[-Stealth] (2.5,0) -- (4,0);
    \draw (4,0.5) -- (6,0.5) -- (6,-0.5) -- (4,-0.5) -- (4,0.5);
    \draw[-Stealth] (6,0) -- (8,0) node[right]{$C(s)$};
    \draw[-Stealth] (7,0) -- (7,-1) -- (2,-1) -- (2,-0.5) node[below left]{$-$};
%
%        \coordinate (a) at (0, 0);
