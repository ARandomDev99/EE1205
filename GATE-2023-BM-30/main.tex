...
\end{figure}
\begin{align}
i(s) &= \frac{\frac{10}{s}\text{V}}{3\text{k}\ohm + \frac{(7\text{k}\ohm)(10\text{k}\ohm + \frac{1}{sC})}{17\text{k}\ohm + \frac{1}{sC}}} \\
i_2(s) &= \frac{7\text{k}\ohm}{17\text{k}\ohm + \frac{1}{sC}}i(s) \\
%&= \frac{\frac{70000}{s}}{121 * 10^6 + \frac{10000}{sC}} \\
%&= \frac{\frac{7}{s}}{121 * 10^2 + \frac{1}{sC}} \\
&= \frac{7 * 10^{-5}}{0.121s + 1} \\
V_c(s) &= i_2(s)\frac{1}{sC} \\
&= \frac{7}{s(0.121s + 1)} \\
&= 7\brak{\frac{\frac{1}{0.121}}{s(s + \frac{1}{0.121})}} \\
&= 7\brak{\frac{1}{s} - \frac{1}{s + \frac{1}{0.121}}}
\end{align}
Taking inverse Laplace transform:
\begin{align}
v_c(t) &= 7u(t)\brak{1 - e^{-\frac{t}{-0.121}}}
\end{align}
\end{document}