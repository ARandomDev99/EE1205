...
\author{Aneesh K\\EE23BTECH11007}
\date{}
...
Center frequency is
\begin{align}
    \omega_c &= \frac{\omega_{p1} + \omega_{p2}}{2} = 0.365 \pi
\end{align}
...
\begin{lstlisting}
https://github.com/ARandomDev99/EE1205/tree/main/Filter_Design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/ARandomDev99/EE1205/blob/main/Filter_Design/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/ARandomDev99/EE1205/blob/main/Filter_Design/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/ARandomDev99/EE1205/tree/main/Filter_Design/codes/exp_calc.py
\end{lstlisting}
